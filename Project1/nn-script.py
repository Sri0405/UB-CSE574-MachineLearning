...
def nnObjFunction(params, *args):
    ...
    # -----Error
    temp_var_1 = np.ones((training_labels.shape[0], training_labels.shape[1]))
    temp_var_1 = temp_var_1 - training_labels
    temp_var_2 = np.ones((Z1.shape[0], Z1.shape[1]))
    temp_var_2 = temp_var_2 - Z1
    temp_var_3 = np.multiply(training_labels, ComputeLog(Z1)) + np.multiply(temp_var_1, ComputeLog(temp_var_2))

    temp_var_3 = np.ndarray.sum(temp_var_3)
    error = np.divide(temp_var_3, (training_data.shape[0] * -1))
